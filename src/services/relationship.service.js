 ...
 *
 * A legacy `ending` row is NOT blocking: unlinkUsers() already ran when it was
 * created, so the user is free to connect with someone new while the sweep
 * cron finishes archiving it.
 */
